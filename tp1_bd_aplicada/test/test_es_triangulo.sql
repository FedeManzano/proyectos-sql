...
EXEC @RES = [db_utils].[library].[sp_Assert_Equals] 1,
...
EXEC @RES = [db_utils].[library].[sp_Assert_Equals] 2,
...
EXEC @RES = [db_utils].[library].[sp_Assert_Equals] 3,'EsIsosceles(1)_(1)_(2)', @RES_ESPERADO, @RES_OBTENIDO, NULL
