...
BEGIN 
    ...
    (
        ...
        Año INT NOT NULL,
        CONSTRAINT PK_Docente_Comision PRIMARY KEY(TipoDocDocente, NroDocDocente, NroComision, CodMAteria, Cuatrimestre),
        ...
        CONSTRAINT FK_Materia FOREIGN KEY(CodMateria) REFERENCES [db_tp_bd_aplicada].[negocio].[Materia](CodMateria),
        CONSTRAINT FK_DiaSemana FOREIGN KEY(DiaSemana) REFERENCES [db_tp_bd_aplicada].[negocio].[Dia_Semana](CodDia)
    )
END
